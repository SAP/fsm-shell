...
- Update the documentation to reflect the renaming of the product from "SAP Field Service Management" to "SAP Field Service and Asset Management"

## [1.27.1] - 2026-05-26

### Added

- Support for OIDC when publishing to npmjs registry
- Support for node 24
...
- Expose models `PermissionRequestV2Payload` and `PermissionRequestV3Payload`
