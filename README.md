...
- [SHELL-SDK Version1 events](#SHELL-SDK-Version1-events)
  - [V1.REQUIRE_CONTEXT](#V1.REQUIRE_CONTEXT)
  - [V1.GET_PERMISSIONS](#V1.GET_PERMISSIONS)
  - [V1.GET_SETTINGS](#V1.GET_SETTINGS)
  - [V1.GET_STORAGE_ITEM](#V1.GET_STORAGE_ITEM)
  - [V1.SET_STORAGE_ITEM](#V1.SET_STORAGE_ITEM)
  - [V1.START_FLOW](#V1.START_FLOW)
- [FLOW-RUNTIME Version1 events](#FLOW-RUNTIME-Version1-events)
  - [V1.FLOWS.REQUIRE_CONTEXT](#V1.FLOWS.REQUIRE_CONTEXT)
