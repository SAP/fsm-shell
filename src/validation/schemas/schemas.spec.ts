...
export const validAuthResponse_v1 = {
  access_token: 'string',
  expires_in: 123,
  token_type: 'string',
};
...
export const validGetFeatureFlagRequest_v1_subschema_1 = {
  key: 'string',
  defaultValue: true,
};
export const validGetFeatureFlagRequest_v1_subschema_2 = [
...
export const validModalOpenRequest_v1 = {
  url: 'string',
  modalSettings: {
    title: 'string',
    size: 'l',
...
export const validGetPermissionsRequest_v2_subschema_1 = {
  objectName: 'string',
  owners: ['string'],
};
export const validGetPermissionsRequest_v2_subschema_2 = [
  { objectName: 'string', owners: ['string'] },
  { objectName: 'string', owners: ['string'] },
];
export const validGetPermissionsRequest_v3_subschema_1 = {
  objectName: 'string',
};
export const validGetPermissionsRequest_v3_subschema_2 = [
  { objectName: 'string' },
  { objectName: 'string' },
];
export const validGetPermissionsResponse_v1 = {
  CREATE: true,
  READ: true,
  UPDATE: true,
  DELETE: true,
...
export const validGetPermissionsResponse_v2 = {
  objectName: 'string',
  owners: ['string'],
  permission: validGetPermissionsResponse_v1,
};
export const validGetPermissionsResponse_v3 = {
  objectName: 'string',
  permission: validGetPermissionsResponse_v1,
};
export const validRequireContextRequest_v1 = {
  ...
  clientSecret: 'string',
  cloudStorageKeys: [
    { name: 'string', dataVersion: 1, companyDependent: true },
  ],
...
export const validGetSettingsRequest_v1_subschema_3 = [
  ['string'],
  ['string', 'string'],
];
...
export const validOutletsRequestContextRequest_v1 = {
  target: 'string',
  assignmentId: 'string',
  showMocks: true,
  outletSettings: {},
...
export const validOutletsRequestDynamicContextRequest_v1 = {
  target: 'string',
  outletSettings: {},
};
...
export const invalidAuthResponse_v1 = {
  access_token: 123,
...
export const invalidGetPermissionsRequest_v1 = {
  objectName: 123,
  owners: 'not-array',
};
...
export const invalidGetPermissionsResponse_v1 = {
  CREATE: 'yes',
  READ: 'yes',
  UPDATE: 'yes',
  DELETE: 'yes',
  UI_PERMISSIONS: ['not-number'],
};
export const invalidGetPermissionsResponse_v2 = {
  objectName: 123,
  owners: 'not-array',
  permission: {},
};
export const invalidGetPermissionsResponse_v3 = {
  objectName: 123,
  permission: {},
};
...
export const invalidOutletsRequestContextRequest_v1 = {
  target: 123,
  assignmentId: 123,
  showMocks: 'yes',
  outletSettings: 123,
...
export const invalidOutletsRequestDynamicContextRequest_v1 = {
  target: 123,
  outletSettings: 123,
};
...
export const invalidGetOrgDataResponse_v1_invalidStatus = {
  key: 'all',
  data: { id: 'level-1', name: 'Root', status: 'INVALID_STATUS' },
};
...
describe('Schemas', () => {
  ...
  function validateSchemasSupporting04and06and07(ajv: Ajv) {
    ...
    validateSchemaHelper(
      ajv,
      'getItemRequest_v1_schema',
      getItemRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getItemRequest_v2_schema',
      getItemRequest_v2_schema
    );
    validateSchemaHelper(
      ajv,
      'getItemResponse_v1_schema',
      getItemResponse_v1_schema
    );
    validateSchemaHelper(
      ajv,
    ...
    validateSchemaHelper(
      ajv,
      'setItemRequest_v1_schema',
      setItemRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getFeatureFlagRequest_v1_schema',
      getFeatureFlagRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getFeatureFlagResponse_v1_schema',
      getFeatureFlagResponse_v1_schema
    );
    validateSchemaHelper(
      ajv,
    ...
    validateSchemaHelper(
      ajv,
      'modalOpenRequest_v1_schema',
      modalOpenRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'modalOpenRequest_v2_schema',
      modalOpenRequest_v2_schema
    );
    validateSchemaHelper(
      ajv,
      'modalCloseRequest_v1_schema',
      modalCloseRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getPermissionsRequest_v1_schema',
      getPermissionsRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getPermissionsRequest_v2_schema',
      getPermissionsRequest_v2_schema
    );
    validateSchemaHelper(
      ajv,
    ...
    validateSchemaHelper(
      ajv,
      'getPermissionsResponse_v2_schema',
      getPermissionsResponse_v2_schema
    );
    validateSchemaHelper(
      ajv,
      'getPermissionsResponse_v3_schema',
      getPermissionsResponse_v3_schema
    );
    validateSchemaHelper(
      ajv,
      'requireContextRequest_v1_schema',
      requireContextRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getSettingsRequest_v1_schema',
      getSettingsRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'getSettingsResponse_v1_schema',
      getSettingsResponse_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'setViewStateRequest_v1_schema',
      setViewStateRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'setViewStateResponse_v1_schema',
      setViewStateResponse_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'outletsRequestContextRequest_v1_schema',
      outletsRequestContextRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'outletsRequestContextResponse_v1_schema',
      outletsRequestContextResponse_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'outletsAddPluginRequest_v1_schema',
      outletsAddPluginRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'outletsRemovePluginRequest_v1_schema',
      outletsRemovePluginRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
      'outletsRequestDynamicContextRequest_v1_schema',
      outletsRequestDynamicContextRequest_v1_schema
    );
    validateSchemaHelper(
      ajv,
  ...
  function validateValidDataAgainstSchemaHelper(
    ajv: Ajv,
    schemaName: string,
    schema: object,
    data: any
  ...
  function validateValidDataAgainstSchemaSupporting04and06and07(ajv: Ajv) {
    validateValidDataAgainstSchemaHelper(
      ajv,
      'authRequest_v1_schema',
      authRequest_v1_schema,
      validAuthRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'authResponse_v1_schema',
      authResponse_v1_schema,
      validAuthResponse_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getItemRequest_v1_schema',
      getItemRequest_v1_schema,
      validGetItemRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getItemRequest_v2_schema',
      getItemRequest_v2_schema,
      validGetItemRequest_v2_subschema_1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getItemRequest_v2_schema',
      getItemRequest_v2_schema,
      validGetItemRequest_v2_subschema_2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getItemResponse_v2_schema',
      getItemResponse_v2_schema,
      validGetItemResponse_v2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'setItemRequest_v1_schema',
      setItemRequest_v1_schema,
      validSetItemRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getFeatureFlagRequest_v1_schema',
      getFeatureFlagRequest_v1_schema,
      validGetFeatureFlagRequest_v1_subschema_1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getFeatureFlagRequest_v1_schema',
      getFeatureFlagRequest_v1_schema,
      validGetFeatureFlagRequest_v1_subschema_2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getFeatureFlagResponse_v1_schema',
      getFeatureFlagResponse_v1_schema,
      validGetFeatureFlagResponse_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'setTitleRequest_v1_schema',
      setTitleRequest_v1_schema,
      validSetTitleRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'modalOpenRequest_v1_schema',
      modalOpenRequest_v1_schema,
      validModalOpenRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'modalOpenRequest_v2_schema',
      modalOpenRequest_v2_schema,
      validModalOpenRequest_v2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'modalCloseRequest_v1_schema',
      modalCloseRequest_v1_schema,
      validModalCloseRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v1_schema',
      getPermissionsRequest_v1_schema,
      validGetPermissionsRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v2_schema',
      getPermissionsRequest_v2_schema,
      validGetPermissionsRequest_v2_subschema_1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v2_schema',
      getPermissionsRequest_v2_schema,
      validGetPermissionsRequest_v2_subschema_2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v3_schema',
      getPermissionsRequest_v3_schema,
      validGetPermissionsRequest_v3_subschema_1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v3_schema',
      getPermissionsRequest_v3_schema,
      validGetPermissionsRequest_v3_subschema_2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsResponse_v1_schema',
      getPermissionsResponse_v1_schema,
      validGetPermissionsResponse_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsResponse_v2_schema',
      getPermissionsResponse_v2_schema,
      validGetPermissionsResponse_v2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsResponse_v3_schema',
      getPermissionsResponse_v3_schema,
      validGetPermissionsResponse_v3
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'requireContextRequest_v1_schema',
      requireContextRequest_v1_schema,
      validRequireContextRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getSettingsRequest_v1_schema',
      getSettingsRequest_v1_schema,
      validGetSettingsRequest_v1_subschema_1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getSettingsRequest_v1_schema',
      getSettingsRequest_v1_schema,
      validGetSettingsRequest_v1_subschema_2
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getSettingsRequest_v1_schema',
      getSettingsRequest_v1_schema,
      validGetSettingsRequest_v1_subschema_3
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getSettingsRequest_v1_schema',
      getSettingsRequest_v1_schema,
      validGetSettingsRequest_v1_subschema_4
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getSettingsResponse_v1_schema',
      getSettingsResponse_v1_schema,
      validGetSettingsResponse_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'setViewStateRequest_v1_schema',
      setViewStateRequest_v1_schema,
      validSetViewStateRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'setViewStateResponse_v1_schema',
      setViewStateResponse_v1_schema,
      validSetViewStateResponse_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'outletsRequestContextRequest_v1_schema',
      outletsRequestContextRequest_v1_schema,
      validOutletsRequestContextRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'outletsRequestContextResponse_v1_schema',
      outletsRequestContextResponse_v1_schema,
      validOutletsRequestContextResponse_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'outletsAddPluginRequest_v1_schema',
      outletsAddPluginRequest_v1_schema,
      validOutletsAddPluginRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'outletsRemovePluginRequest_v1_schema',
      outletsRemovePluginRequest_v1_schema,
      validOutletsRemovePluginRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'outletsRequestDynamicContextRequest_v1_schema',
      outletsRequestDynamicContextRequest_v1_schema,
      validOutletsRequestDynamicContextRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getOrgDataRequest_v1_schema',
      getOrgDataRequest_v1_schema,
      validGetOrgDataRequest_v1
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getOrgDataResponse_v1_schema',
      getOrgDataResponse_v1_schema,
      validGetOrgDataResponse_v1_orgLevel
    );
    validateValidDataAgainstSchemaHelper(
      ajv,
      'getOrgDataResponse_v1_schema',
      getOrgDataResponse_v1_schema,
      validGetOrgDataResponse_v1_allocations
    );
  }
  ...
  function validateInvalidDataAgainstSchemaSupporting04and06and07(ajv: Ajv) {
    ...
    validateInvalidDataAgainstSchemaHelper(
      ...
      'authResponse_v1_schema',
      authResponse_v1_schema,
      invalidAuthResponse_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getItemRequest_v1_schema',
      getItemRequest_v1_schema,
      invalidGetItemRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getItemRequest_v2_schema',
      getItemRequest_v2_schema,
      invalidGetItemRequest_v2
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getItemResponse_v2_schema',
    ...
    validateInvalidDataAgainstSchemaHelper(
      ...
      'setItemRequest_v1_schema',
      setItemRequest_v1_schema,
      invalidSetItemRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getFeatureFlagRequest_v1_schema',
      getFeatureFlagRequest_v1_schema,
      invalidGetFeatureFlagRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getFeatureFlagResponse_v1_schema',
      getFeatureFlagResponse_v1_schema,
      invalidGetFeatureFlagResponse_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'setTitleRequest_v1_schema',
    ...
    validateInvalidDataAgainstSchemaHelper(
      ...
      'modalOpenRequest_v1_schema',
      modalOpenRequest_v1_schema,
      invalidModalOpenRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'modalOpenRequest_v2_schema',
      modalOpenRequest_v2_schema,
      invalidModalOpenRequest_v2
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'modalCloseRequest_v1_schema',
      modalCloseRequest_v1_schema,
      invalidModalCloseRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v1_schema',
      getPermissionsRequest_v1_schema,
      invalidGetPermissionsRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v2_schema',
      getPermissionsRequest_v2_schema,
      invalidGetPermissionsRequest_v2
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsRequest_v3_schema',
    ...
    validateInvalidDataAgainstSchemaHelper(
      ...
      'getPermissionsResponse_v2_schema',
      getPermissionsResponse_v2_schema,
      invalidGetPermissionsResponse_v2
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getPermissionsResponse_v3_schema',
      getPermissionsResponse_v3_schema,
      invalidGetPermissionsResponse_v3
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'requireContextRequest_v1_schema',
      requireContextRequest_v1_schema,
      invalidRequireContextRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getSettingsRequest_v1_schema',
      getSettingsRequest_v1_schema,
      invalidGetSettingsRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getSettingsResponse_v1_schema',
      getSettingsResponse_v1_schema,
      invalidGetSettingsResponse_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'setViewStateRequest_v1_schema',
      setViewStateRequest_v1_schema,
      invalidSetViewStateRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'setViewStateResponse_v1_schema',
      setViewStateResponse_v1_schema,
      invalidSetViewStateResponse_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'outletsRequestContextRequest_v1_schema',
      outletsRequestContextRequest_v1_schema,
      invalidOutletsRequestContextRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'outletsRequestContextResponse_v1_schema',
      outletsRequestContextResponse_v1_schema,
      invalidOutletsRequestContextResponse_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'outletsAddPluginRequest_v1_schema',
      outletsAddPluginRequest_v1_schema,
      invalidOutletsAddPluginRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'outletsRemovePluginRequest_v1_schema',
    ...
    validateInvalidDataAgainstSchemaHelper(
      ...
      'outletsRequestDynamicContextRequest_v1_schema',
      outletsRequestDynamicContextRequest_v1_schema,
      invalidOutletsRequestDynamicContextRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getOrgDataRequest_v1_schema',
      getOrgDataRequest_v1_schema,
      invalidGetOrgDataRequest_v1
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getOrgDataResponse_v1_schema',
    ...
    validateInvalidDataAgainstSchemaHelper(
      ...
      'getOrgDataResponse_v1_schema',
      getOrgDataResponse_v1_schema,
      invalidGetOrgDataResponse_v1_missingData
    );
    validateInvalidDataAgainstSchemaHelper(
      ajv,
      'getOrgDataResponse_v1_schema',
      getOrgDataResponse_v1_schema,
      invalidGetOrgDataResponse_v1_invalidStatus
    );
  }
